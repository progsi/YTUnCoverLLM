...
python preprocessing/3_write_IOB_dataset.py -i data/intermediate/shs100k2_IOB.parquet -o data/intermediate/shs100k2/ 
...
python preprocessing/3_write_IOB_dataset.py -i data/intermediate/datacos_IOB.parquet -o data/intermediate/datacos/ 

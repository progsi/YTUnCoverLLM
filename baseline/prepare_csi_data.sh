...
python preprocessing/3_format_biotag_dataset.py -i data/shs100k2_biotag.parquet -o baseline/music-ner-eacl2023/data/shs100k2/ --minimum_ents 2
...
python preprocessing/3_format_biotag_dataset.py -i data/datacos_biotag.parquet -o baseline/music-ner-eacl2023/data/datacos/ --minimum_ents 2

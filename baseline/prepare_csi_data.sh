...
python preprocessing/2_make_IOB_datasets.py -i data/intermediate/shs100k2_processed.parquet -o data/intermediate/shs100k2_IOB.parquet --all --baseline_names
...
python preprocessing/2_make_IOB_datasets.py -i data/intermediate/datacos_processed.parquet -o data/intermediate/datacos_IOB.parquet --all --baseline_names

# Code is adapted from https://github.com/deezer/music-ner-eacl2023/blob/main/music-ner/src/eval_utils.py
...
def compute_results(
    ...
    """Compute NER metrics.
    Args:
        true_labels (list): true IOB tags
        true_predictions (list): predicted IOB tags
        ent_types (list, optional): labels. Defaults to ["Artist", "WoA"].
        eval_schemas (list, optional): evaluation method. Defaults to ["strict", "ent_type", "exact"].
    Returns:
    """
    metrics_results = {
        "precision": [],
